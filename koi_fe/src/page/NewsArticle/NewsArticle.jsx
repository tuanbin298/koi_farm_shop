...
import { GET_ARTICLES } from "../../page/api/Queries/articles"; // Cập nhật đường dẫn nếu cần
                ...
                >
                  <div className="article">
                    ...
                    <div className="article__info">
                      <h4 className="newsArticle-title">{article.name}</h4>
                      <p className="newsArticle-content">{article.content}</p>
