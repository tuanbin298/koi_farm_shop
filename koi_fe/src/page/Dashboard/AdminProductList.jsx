...
export default function AdminProductList() {
    const { data: getProducts, error, loading } = useQuery(GET_ALL_PRODUCTS_ADMIN);
    ...
    const handleDelete = () => {
        ...
        const updatedproducts = products.filter(order => !selectedProducts.includes(order.id));
