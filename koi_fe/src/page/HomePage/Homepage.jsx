      ...
      <div className="web-container">
        <div className="banner">
          <div className="banner-content">
            ...
            >
              <Link to="/koiList">Các giống cá Koi được bán</Link>
            </Button>
          </div>
        </div>
        <section className="introduction-section">
          <div className="introduction-content">
            <div className="text-section">
              ...
              <p>
                Với mục tiêu kết nối những người yêu thích cá Koi, trang web
                chia sẻ các bài viết về cách nuôi dưỡng, chăm sóc, và bảo vệ sức
                khỏe cá Koi. Ngoài ra, CaKoiViet còn giới thiệu các giống cá Koi
                nổi bật và những mẹo hữu ích cho người chơi cá cảnh.
              </p>
            </div>
        ...
        <section className="serviceSection">
          <div className="titleServiceSection">
            ...
            >
              ...
              bạn chăm sóc và phân phối cá của mình trong một môi trường chuyên
              nghiệp và an toàn.
            </p>
            <Flex
          ...
          <div className="quoteContent">
            ...
            <p className="quoteText">
              <div>
                ...
                joy within our fast-paced and often busy lives, which is the sad
                reality of modern society in our world. We want to bring peace
                and tranquility to the United States through koi."
              </div>
